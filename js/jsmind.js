...
(function($w){
    ...
    jm.node = function(sId,iIndex,sTopic,oData,bIsRoot,oParent,eDirection,bExpanded,link){
    ...
    jm.mind.prototype = {
        ...
        add_node:function(parent_node, nodeid, topic, data, idx, direction, expanded,link){
            if(typeof parent_node === 'string'){
                return this.add_node(this.get_node(parent_node), nodeid, topic, data, idx, direction, expanded,link);
            }
            var nodeindex = idx || -1;
            if(!!parent_node){
                ...
                if(parent_node.isroot){
                    ...
                    node = new jm.node(nodeid,nodeindex,topic,data,false,parent_node,d,expanded,link);
                }else{
                    node = new jm.node(nodeid,nodeindex,topic,data,false,parent_node,parent_node.direction,expanded,link);
                }
    ...
    jm.format = {
        node_tree:{
            ...
            _extract_subnode:function(mind, node_parent, node_json){
                ...
                //alert(node_json.link)
                var node = mind.add_node(node_parent, node_json.id, node_json.topic, data, null, d, node_json.expanded,node_json.link);
            ...
            _extract_subnode:function(mind, parentid, node_array){
                ...
                while(i--){
                    ...
                    if(node_json.parentid == parentid){
                        ...
                        mind.add_node(parentid, node_json.id, node_json.topic, data, null, d, node_json.expanded,node_json.link);
                        node_array.splice(i,1);
                        extract_count ++;
